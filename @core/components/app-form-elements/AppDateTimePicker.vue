...
compAttrs.config = {
  ...compAttrs.config,
  prevArrow:
    '<i class="ri-arrow-left-s-line v-icon" style="font-size: 22px; height: 22px; width: 22px;"></i>',
  nextArrow:
    '<i class="ri-arrow-right-s-line v-icon" style="font-size: 22px; height: 22px; width: 22px;"></i>',
};
