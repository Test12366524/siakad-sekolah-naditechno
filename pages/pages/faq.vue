...
<template>
  <section>
    <!-- 👉 Search -->
    <AppSearchHeader v-model="faqSearchQuery" custom-class="mb-6">
      <template #default>
        <h4 class="text-h4 text-primary mb-2">Hello, how can we help?</h4>
    ...
    <VRow>
        ...
        >
          ...
          >
            <div class="d-flex align-center mb-4 gap-x-4">
              <VAvatar rounded="lg" color="primary" variant="tonal" size="50">
      ...
      >
        <VIcon icon="ri-question-line" start size="20" />
    ...
    <div class="text-center mt-6">
      <div class="py-6">
        <VChip color="primary" size="small"> Question </VChip>
        <h4 class="text-h4 my-2">You still have a question?</h4>
          ...
          >
            <VCardText class="pa-6">
              <VAvatar
                ...
                class="mb-4"
              >
                <VIcon :icon="contact.icon" size="30" />
              </VAvatar>
