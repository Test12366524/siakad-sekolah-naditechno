  ...
  <div class="front-page-navbar">
    <VAppBar
      ...
      :style="
        y > 20
          ? ''
          : `background-color: rgba(var(--v-theme-surface),${props.navbarInitialOpacity})`
      "
      height="62"
    >
      ...
      <div class="d-flex align-center">
          ...
          >
            <div class="d-flex gap-x-3 align-center">
              ...
              <div
                ...
                :class="[
                  $vuetify.display.lgAndUp ? 'd-block' : 'd-none',
                  $vuetify.display.mdAndUp ? 'd-none' : 'd-block',
                ]"
              >
        ...
        >
                      ...
                      <ul>
                        ...
                        >
                          <NuxtLink
                            ...
                            "
                            :class="
                              isCurrentRoute(listItem.to) ? 'active-link' : ''
                            "
                          >
                            <div class="d-flex align-center">
                              <VIcon
          ...
          <NuxtLink to="/" target="_blank" class="nav-link font-weight-medium">
            Admin
          </NuxtLink>
        </div>
      </div>
