...
const isAddressSameWithKtp = computed(
  () => props.type !== "address" && props.formData.address_same_with_ktp == 1
);
    ...
    <VCardItem>
      <VRow>
        ...
        <VCol cols="12" v-if="type === 'address_domicile'">
          <VCheckbox
            v-model="formData.address_same_with_ktp"
            :readonly="viewOnly"
            :value="1"
            :error-messages="validationErrors[type + '_same_with_ktp']"
        ...
        <VCol cols="12" class="p-0">
          <VRow class="p-0 m-0">
            ...
            <VCol cols="6">
              <VTextField
                :error-messages="validationErrors[type + '.full_address']"
            ...
            <VCol cols="6">
              <VAutocomplete
                :error-messages="validationErrors[type + '.province_id']"
            ...
            <VCol cols="6">
              <VAutocomplete
                :error-messages="validationErrors[type + '.city_id']"
            ...
            <VCol cols="6">
              <VAutocomplete
                :error-messages="validationErrors[type + '.district_id']"
            ...
            <VCol cols="6">
              <VAutocomplete
                :error-messages="validationErrors[type + '.subdistrict_id']"
            ...
            <VCol cols="6">
              <VTextField
                type="number"
                :error-messages="validationErrors[type + '.post_code']"
